...
function MyUploadAdapter(loaderIn, config) {
...
// default config not Support Class
// class MyUploadAdapter {
//     loaderXccjh;
//     config;
//
//     constructor(loaderIn, config) {
//         this.loaderXccjh = loaderIn;
//         this.config = config;
//     }
//
...
export function myCustomUploadAdapterPlugin(editor) {
    editor.plugins.get('FileRepository').createUploadAdapter = (loaderIn) => {
        return new MyUploadAdapter(loaderIn, editor.config._config);
    };
}
